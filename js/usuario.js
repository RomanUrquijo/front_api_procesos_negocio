//funciones js para el modulo usuarios
...
function eliminaUsuario(id){
    ...
    fetch(urlApi+"/usuarios/"+id,settings)
    .then(response => response.json())
    .then(function(data){
        listarUsuarios();
...
function registerForm(){
    cadena = `
            ...
            <form action="" method="post" id="myForm">
                ...
                <label for="documento"  class="form-label">Last document</label>
...
async function registrarUsuario(){
    ...
    const request = await fetch(urlApi+"/usuarios", {
        method: 'POST',
        headers:{
            'Accept': 'application/json',
            'Content-Type': 'application/json'
